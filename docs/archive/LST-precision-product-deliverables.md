...
| metadata.json | [Metadata description](https://constellr.github.io/product-lst/archive/LST-zoom-metadata/) | json |
...
|--------|-------------|-------------|
| lst.tiff | LST data | Cloud optimized geotiff |
| metadata.json | [Metadata description](https://constellr.github.io/product-lst/archive/LST-precision-metadata/) | json |
| lst_composite.tiff | Temperature quicklook | Cloud optimized geotiff |
| lst_thumbnail.jpg | LST Thumbnail | jpg |
