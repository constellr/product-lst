...
??? note "When should you use LSTfusion?"
    ...
    Need asset-level precision for critical infrastructure? → [Explore LSTprecision](https://constellr.github.io/product-lst/archive/LST-precision/)  
    Want to visually detect fine-grained variations locally? → [Explore LSTzoom](https://constellr.github.io/product-lst/archive/LST-zoom/)
