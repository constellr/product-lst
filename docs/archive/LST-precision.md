...
??? note "When should you use LSTprecision?"
    ...
    Need broader, cloud-free daily coverage? → [Discover LSTfusion](https://constellr.github.io/product-lst/archive/LST-fusion/) 

??? note "How is LSTprecision created?"
    LSTprecision is derived from the high-resolution measurements acquired by the SkyBee satellite instruments of [constellr’s HiVe constellation](https://constellr.github.io/product-lst/archive/our-technology/). Following an [advanced calibration and validation (cal/val) procedure](https://constellr.github.io/product-lst/archive/LST-precision-cal-val-procedure/), ensuring highly accurate and well georeferenced radiance data, a sequence of processing steps is applied to generate the full LSTprecision product bundle. 
    ...
    Surface Reflectance is derived from the ten [VNIR bands](https://constellr.github.io/product-lst/archive/our-technology/) using as input the generated masks and atmospheric amounts. The constellr SR algorithm includes corrections for adjacency effects, providing SR with high accuracy for any type of scene, including vegetation, or buildings and infrastructure suitable for a large range of applications.  
...
??? note "How accurate is LSTprecision?"
    ...
    Explore the details of our [Cal/Val approach](https://constellr.github.io/product-lst/archive/LST-precision-cal-val-procedure/). These accuracy levels are supported bz an independent ESA-led assessment, which confirms consistent thermal performance and reliable calibration across acquisitions.  
