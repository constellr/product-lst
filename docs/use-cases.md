# **Thermal Insights** {style="color: #123774;margin-bottom: 5px;"}
...
---------------------
## **Vegetation Intelligence** {style="color: #123774;margin-bottom: 5px; text-align: center;"}
...
<div style="display: flex; align-items: center; justify-content: flex-start; gap: 20px;">
  ...
  <div style="flex: 1;">
    ...
    <figcaption style="font-size: 14px;">A bare soil field in Iowa, USA - June 2024</figcaption>
  </div>
</div>
...
<div style="flex: 1;">
    ...
    <figcaption style="font-size: 14px;">Wheat fields in Madhya Pradesh, India - March 2021 </figcaption>
</div>
<div style="flex: 2;">
...
--------------
## **Urban Climate Resilience** {style="color: #202A78;margin-bottom: 5px; text-align: center;"}
...
<div style="flex: 1;">
    ...
    <figcaption style="font-size: 14px;">Milano, Italy - December 2024</figcaption>
</div>
<div style="flex: 2;">
...
<div style="display: flex; align-items: center; justify-content: flex-start; gap: 20px;">
  ...
  <div style="flex: 1;">
    ...
    <figcaption style="font-size: 14px;">Medellin, Colombia - July 2024</figcaption>
  </div>
</div>
...
---------------------
## **Resilient Infrastructure** {style="color: #123774;margin-bottom: 5px; text-align: center;"}
...
<div style="flex: 1;">
    ...
    <figcaption style="font-size: 14px;">Colorado, USA - February 2024</figcaption>
</div>
<div style="flex: 2;">
...
<div style="display: flex; align-items: center; justify-content: flex-start; gap: 20px;">
  ...
  <div style="flex: 1;">
    ...
    <figcaption style="font-size: 14px;">Power Plant, Kuwait - November 2023</figcaption>
  </div>
</div>
...
<div style="flex: 1;">
    ...
    <figcaption style="font-size: 14px;">Greenhouse in the Netherlands - April 2024</figcaption>
</div>
<div style="flex: 2;">
